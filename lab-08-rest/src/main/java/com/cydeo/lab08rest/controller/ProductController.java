...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<ResponseWrapper> retrieveListProduct() {

        return ResponseEntity
                .ok(new ResponseWrapper("Products are successfully retrieved", productService.retrieveListProduct(), HttpStatus.OK));
    }

    @PutMapping // for updating the object
    public ResponseEntity<ResponseWrapper> updateProduct(@RequestBody ProductDTO productDTO) {

        return ResponseEntity.
                ok(new ResponseWrapper("Product is successfully updated",
    ...
    public ResponseEntity<ResponseWrapper> createProduct(@RequestBody ProductDTO productDTO) {
        ...
        return ResponseEntity.
                ok(new ResponseWrapper("Product is successfully created",
    ...
    public ResponseEntity<ResponseWrapper> retrieveProductByName(@PathVariable("name") String name) {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Retrieve product by name"
    ...
    public ResponseEntity<ResponseWrapper> retrieveProductByTop3ProductByPrice() {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Retrieve  top 3 products"
    ...
    public ResponseEntity<ResponseWrapper> countProductByPrice(@PathVariable("price") BigDecimal price) {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Retrieve  product by price"
    ...
    public ResponseEntity<ResponseWrapper> retrieveProductByPriceAndQuantity(@PathVariable("price") BigDecimal price,
        ...
        return ResponseEntity.ok(new ResponseWrapper("Retrieve  product by price and quantity"
    ...
    public ResponseEntity<ResponseWrapper> retrieveByCategory(@PathVariable("id") Long categoryId) {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Retrieve  product by category id"
