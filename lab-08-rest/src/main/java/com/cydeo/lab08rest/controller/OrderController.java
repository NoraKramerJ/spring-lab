...
public class OrderController {
    ...
    @GetMapping
    public ResponseEntity<ResponseWrapper> retrieveListOfOrder() {
    ...
    public ResponseEntity<ResponseWrapper> updateOrder(@RequestBody OrderDTO orderDTO){
        ...
        return ResponseEntity.ok(new ResponseWrapper("Product is successfully updated",orderService.updateOrder(orderDTO),HttpStatus.OK));
    }
}
